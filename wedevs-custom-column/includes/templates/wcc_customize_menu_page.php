<div class="wrap">
    ...
    <div class="tablenav top">
        <form method="get">
            ...
            <div class="alignleft actions">
                <?php $selected_author = isset($_GET['wcc_author']) ? $_GET['wcc_author'] : '-1'; ?>
                <label class="screen-reader-text" for="author">Filter by Author</label>
                <select name="wcc_author" id="author" class="postform">
            ...
            <input type="submit" class="button" value="<?php esc_attr_e('Apply Filters', 'wcc'); ?>">
        </form>
    </div>
    ...
    <table class="wp-list-table widefat fixed table_view-list striped posts">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td>
                        <strong><a href="<?php echo get_edit_post_link($post->ID); ?>" class="row-title"><?php echo $post->post_title; ?></a></strong>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        foreach ($comments as $comment) {
                            $comment_count = get_comment_count($comment->comment_ID)['approved'];
                            $comment_link = get_edit_comment_link($comment->comment_ID);
                            $comment_text = sprintf(_n('%s Comment', '%s Comments', $comment_count, 'wcc'), $comment_count);
                            ...
                            <span class="screen-reader-text">' . esc_html($comment_text) . '</span></a>';
                        }
                        echo '</div>';
                        ?>
                    </td>
